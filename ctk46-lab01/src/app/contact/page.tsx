...
export default function ContactPage() {
  const email = "haidgh@sv.dlu.edu.vn";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="bg-emerald-600 dark:bg-emerald-500 rounded-[2.5rem] p-10 text-white shadow-2xl shadow-emerald-900/20">
          ...
          <div className="space-y-4">
            <a href="https://github.com/haidgh" target="_blank" className="flex items-center justify-between p-4 bg-white/10 rounded-2xl hover:bg-white/20 transition-colors">
